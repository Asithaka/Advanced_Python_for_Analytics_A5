...
print(f" Superstore's smallest sale {salesArray.min()}")
print(f" Superstore's largest sale {salesArray.max()}")

## Step 3: Print an array that will show which sales are greater than or equal to $100.
print("-----------------------------------------------   STEP THREE  -----------------------------------------------")

subArray = salesArray[salesArray > 100]
print(subArray)
...
print(feesArray)
print(f"total fees {feesArray.sum()}")
...
print(salesArray)
updatedArray = np.append(salesArray,[newRegister],axis =0)
print(updatedArray)
